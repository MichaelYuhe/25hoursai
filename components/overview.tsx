...
export default function Overview() {
  ...
  return (
    <div className="w-full border rounded-lg p-4 mb-6 bg-white shadow-sm">
      <h3 className="text-xl font-semibold mb-2">Team Overview</h3>
      
      <div className="flex justify-between items-start mb-4">
        <div>
          <p className="text-gray-700 mb-1">Work Schedule:</p>
          <p className="text-sm text-gray-500">{selectedWorkHour.description}</p>
        ...
        <div className="text-right">
          <p className="text-gray-700">Total Monthly Cost:</p>
      ...
      <div>
        <p className="text-gray-700 mb-2">Employees ({selectedEmployees.length}):</p>
        {selectedEmployees.length > 0 ? (
          ...
          <p className="text-sm text-gray-500 italic">No employees selected. Click on LLM cards below to add them to your team.</p>
        )}
      </div>
    </div>
  );
